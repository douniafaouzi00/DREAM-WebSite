...
import {Button, Col, Container, FormGroup, Input, notify, Row} from "design-react-kit";
...
export default function SignInPage(props){
    ...
    /**
     * login function
     * It is use call to login the agronomist when the "Sign in" button is pressed.
